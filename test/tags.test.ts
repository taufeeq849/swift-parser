...
describe("Tags", () => {
  describe("TagFactory", () => {
    ...
    it("should create tag 13D (TagDateTimeIndication)", () => {
      ...
      expect(tag.fields.dateTimestamp).toEqual(
        helperModels.Date.forOffsetDateTime({
          date: "090108",
          time: "1515",
          offset: "+1300",
        })
    ...
    it("should create tag 60 (OpeningBalance)", () => {
      ...
      expect((tag.fields.date as Date).toISOString().substr(0, 10)).toEqual(
        "2016-05-07"
      );
    ...
    it("should create tag 61 (StatementLine)", () => {
      ...
      expect(
        (tag.fields.entryDate as Date).toISOString().substr(0, 10)
      ).toEqual("2016-05-07");
      expect(tag.fields.amount).toEqual(BigNumber(-123.89));
    ...
    it("should create tag 61 (with extraDetails)", () => {
      const str =
        "1605070507D123,89NTRFNONREF//B4E07XM00J000023\nSUPPLEMENTARY_DETAILS";
      const tag = tf.createTag("61", null, str);
      expect((tag.fields.date as Date).toISOString().substr(0, 10)).toEqual(
        "2016-05-07"
      );
